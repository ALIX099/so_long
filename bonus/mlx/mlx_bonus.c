...
/*   Updated: 2025/04/06 14:03:55 by abouknan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_two(t_game *game, int w, int h)
{
	...
	if (!game->coin || !game->back || !game->img_killer[0]
		|| !game->img_killer[1] || !game->img_killer[2] || !game->exit_closed
		|| !game->exit_opened || !game->player_down || !game->player_left
		|| !game->player_up || !game->player_right || !game->wall
		|| !game->img_killer[3] || !game->img_killer[4])
	{
